          ...
          child: Column(
            ...
            children: [
              ...
              ListSection(
                title: '내 관심지역',
                list: listToShow,
                onItemTap: (item) => context.push('/residence/${item.name}'),
                onAddTap: () async {
                  ...
                  if (model != null && model.jibunAddress != null) {
                    print(
                        'Selected Address: ${PlaceUtils.mapAddressForAPI(model.jibunAddress!)}');
                    ...
                    try {
                      ...
                      final notifier =
                          ref.watch(interestedAreaListProvider.notifier);
                      notifier.fetchInterestedAreaList();
