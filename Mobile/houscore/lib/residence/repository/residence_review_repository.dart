...
part 'residence_review_repository.g.dart';

// 통신을 위한 객체를 제공함
final residenceReviewRepositoryProvider = Provider<ResidenceReviewRepository>(
      (ref) {
    final dio = ref.watch(dioProvider);
    final repository =
    ResidenceReviewRepository(dio, baseUrl: 'http://$ip/api/residence/review');
...
@RestApi()
abstract class ResidenceReviewRepository implements IBasePaginationRepository<ResidenceReviewModel>{
  factory ResidenceReviewRepository(Dio dio, {String baseUrl}) =
  _ResidenceReviewRepository;
