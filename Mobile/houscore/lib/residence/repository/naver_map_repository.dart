...
final naverMapRepositoryProvider = Provider<NaverMapRepository>((ref) {
  ...
  dio.options.headers['X-NCP-APIGW-API-KEY-ID'] = 'xkhnb3razm';
  dio.options.headers['X-NCP-APIGW-API-KEY'] = 'TEkdbqAsCpEEF6gfrU1gDVxPRwCpMv3RFj4vBiTJ';
...
abstract class NaverMapRepository {
  ...
  @Headers(<String, dynamic>{
    'X-NCP-APIGW-API-KEY-ID': 'xkhnb3razm',
    'X-NCP-APIGW-API-KEY': 'TEkdbqAsCpEEF6gfrU1gDVxPRwCpMv3RFj4vBiTJ'
  })
